...
This tutorial in particular tackles the problem of filling missing values in time series. The lectures explain basic methods based on interpolation, then move to Gaussian Processes. Multiplicative ensembles are introduces as an approach to model example-dependent variance.
...
```sh
git clone https://github.com/a3i-2022-2023/03-sf-gp
```
